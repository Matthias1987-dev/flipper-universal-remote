#include "remote_button_panel.h"

#define TAG "RemoteControllerApp"
...
int32_t remote_button_panel_app(void* p) {
    UNUSED(p);

    XboxController* app = remote_button_panel_app_alloc();
    view_dispatcher_run(app->view_dispatcher);

    remote_button_panel_app_free(app);
